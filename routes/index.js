...
module.exports = function (app) {
  ...
  app.post('/api/forms/:id', checkFormAuthor, forms.update);//update form's template
  app.delete('/api/forms/:id', checkFormAuthor, forms.delete);
  ...
  app.get('/forms/:id/responses/:response_id', checkFormAuthor, require('./responses.js').getOne);//get one response by id 
